							...
							<div class="row mt-9">
								...
								<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
									<div class="card overflow-hidden">
										<div class="card-body iconfont text-center">
											<h5>Voitures en vente</h5>
											<h3 class="counter mb-0 fs-30 mt-1">{{count($total_cars->where('available' ,'=', 1)->where('visible', '=', 1))}}</h3>
										</div>
									</div>
								</div>
								<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
									<div class="card overflow-hidden">
										<div class="card-body iconfont text-center">
											<h5>Voitures en pause</h5>
											<h3 class="counter mb-0 fs-30 mt-1">{{count($total_cars->where('available' ,'=', 1)->where('visible', '=', 0))}}</h3>
										</div>
									</div>
								</div>
								<div class="col-sm-12 col-md-6 col-lg-4 col-xl-4">
									<div class="card overflow-hidden">
										<div class="card-body iconfont text-center">
											<h5>Voitures en vendus</h5>
											<h3 class="counter mb-0 fs-30 mt-1">{{count($total_cars->where('available' ,'=', 0))}}</h3>
										</div>
									</div>
								</div>
								<div class="col-sm-12 col-md-6 col-lg-4 col-xl-8">
									<div class="card overflow-hidden">
										<div class="card-body iconfont text-center">
											<h5>Voitures particulier</h5>
											<h3 class="counter mb-0 fs-30 mt-1">{{count($total_cars->where('particular_id' ,'!=', NULL))}}</h3>
										</div>
									</div>
								</div>
							</div>
